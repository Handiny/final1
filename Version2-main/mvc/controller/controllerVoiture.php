...
switch ($action) {
	...
	if ($error === 0) {
		if ($img_size > 1250000) {
			...
			if($recherche==null){
				$u = new ModelVoiture($immatriculation, $marque, $modele, $annee,$date_validation_tech , $boitevitesse, $kilometrage, $puissance_fiscale, $carburant,$image_voiture, $description,$prix_loc,NULL);	
				$tab = array(
